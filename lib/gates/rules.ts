 ...
 * about it. Five real generations failed on rules the prompt never mentioned —
 * `keyword.h1` among them — which is drift, not a model problem.
 */
export const RULES = {
  // gate 1 — strategy
  ...
  'structure.tldr': 'Open with a labelled TL;DR.',
