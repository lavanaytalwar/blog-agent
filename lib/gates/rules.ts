...
export const RULES = {
  ...
  'length.floor': 'Length is measured in characters and the floor comes from the pages that currently rank, not from a fixed number. The prompt states the exact range for this keyword.',
  'length.ceiling': 'Do not pad. Twice the length of the pages that rank is padding, not depth.',
